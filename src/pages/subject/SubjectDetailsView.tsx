        ...
        <div className="p-6 md:p-10 max-w-[1400px] mx-auto min-h-screen bg-base relative">
            ...
            <div className="mb-8 border-b border-border pb-6">
                ...
                <p className="text-secondary max-w-4xl text-sm md:text-base mb-6 leading-relaxed">
                    {t('subject.details.edition')}: <span className="font-medium text-primary">{subject.edition}</span> | {t('subject.details.organization')}: <a href={`https://gitea.com/${subject.organizationName}`} target="_blank" rel="noreferrer" className="font-medium text-brand hover:underline">{subject.organizationName}</a>
                </p>
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <div className="flex gap-4 text-sm font-semibold text-secondary">
                                ...
                                <button className="hover:text-primary transition-colors">{t('subject.details.repos.filter')}</button>
                                <button className="hover:text-primary transition-colors">{t('subject.details.repos.sort')}</button>
                            </div>
                        </div>
                                ...
                                return (
                                    <div key={repo.id} className={`border rounded-xl p-5 shadow-sm flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 transition-colors ${colors}`}>
                                        ...
                                        <div className="flex gap-2 shrink-0 mt-2 sm:mt-0">
                                            ...
                                            <button className="px-4 py-2 bg-brand border border-brand rounded-lg text-sm font-bold text-white hover:bg-brand-hover shadow-sm transition-colors">
